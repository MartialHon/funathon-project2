...
Define a `TrainingConfig` and train on a small subsample so it completes quickly. You can see the `TrainingConfig` documentation [here](https://inseefrlab.github.io/torchTextClassifiers/api/configs.html#trainingconfig)
